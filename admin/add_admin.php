...
include('../dist/includes/dbcon.php');
	...
	mysqli_query($con,"update user set  Role='0'and branch_id='0' where username='$username'")or die(mysqli_error($con));
	date_default_timezone_set("Africa/Nairobi"); 
	$date = date("Y-m-d H:i:s");
	$user_id = $_SESSION['id'];	
	    $remarks="has added  new admin  account  in the system at "; 
