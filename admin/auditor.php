			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class = "col-md-4 col-lg-4 col-xs-4">
						<?php include 'add_auditor_form.php';?>
					</div>
						...
						<div class="box-body"style="overflow-x:auto;">
						 <table id="datatable" class="table table-striped table-bordered table-responsive">
							 ...
							 <tbody>
									<?php	
									include 'dbcon.php';								
										$query1=mysqli_query($con,"select * from user  WHERE Role='1' ORDER BY user_id ASC")or die(mysqli_error($con));
								...
								<tr>
									...
									<td>
										...
										<?php include 'update_auditor_modal.php';?>
								<?php }?>
							 </tbody>								
						 </table>
						</div>
