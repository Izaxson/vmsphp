...
include('../dist/includes/dbcon.php');
	...
	mysqli_query($con,"update user set branch_id=5 where username='$username'")or die(mysqli_error($con));
	date_default_timezone_set("Africa/Nairobi"); 
	$date = date("Y-m-d H:i:s");
	$user_id = $_SESSION['id'];	
	    $remarks="has added  new supervisor  account records in the system at "; 
