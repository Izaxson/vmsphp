...
$_SESSION['last_login_timestamp'] = time();
      ...
      {  
           if((time() - $_SESSION['last_login_timestamp']) > 600) //  10 mins
           {  
      ...
      <div class="content-wrapper">
        <div class="container">
					...
					<div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-orange">
                          ...
                          <div class="icon" style="margin-top:10px">
							<i class="fa fa-history"></i> 
								<!--<img src="https://img.icons8.com/dusk/64/000000/car-service.png">-->
                     ...
                     <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                          ...
                          <a href="tools.php" class="small-box-footer">
                            Go <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div><!-- ./col -->
					   ...
					   <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                          ...
                          <a href="occurence.php" class="small-box-footer">
                            Go <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div><!-- ./col -->
         ...
         <p> <b>INSTRUCTIONS:</b></p>
			...
			<li>All Records should be well document in Real Trips  for each station/Department</li></b>
			 </ul> </div><!-- /.col (right) -->
        ...
        <div class="col-md-4">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                 <a href="#" class="site_title"><i class="fa fa-cog"></i> <span><b>DRIVER</b></span></a>
                </div><!-- /.box-header -->
    <?php
...
?>
                <div class="box-body">
				  ...
				  <img src="manager.png" height='66' width='76' alt="..." class="img-circle profile_img"><br> <br>
 ...
 <div class="login-logo">
	  ...
	  <img src="Realtripslogo.jpg" height='120' width='150' alt="..." class="responsive"><br> <br>
       </div>
                  <img src="Capture.PNG" alt="sgs logo" width="300" height="120" class="responsive">
                </div><!-- /.box-body -->
              </div><!-- /.box -->
