...
?>
  <head>
    ...
    <title>My Approvals | <?php include('../dist/includes/title.php');?></title>
...
<?php
		...
		$query=mysqli_query($con,"select * from trips WHERE branch='$branch_name' and driver='$name' and Application_status='Approved'")or die(mysqli_error());
