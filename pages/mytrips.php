...
?>
  <head>
    ...
    <title>My Trips | <?php include('../dist/includes/title.php');?></title>
      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              <li><a href="home.php"><i class="fa fa-dashboard"></i> My Trip Records</a></li>
            ...
            <div class="container">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Trip Record</h3>
                </div><!-- /.box-header -->
                <div class="box-body ">
...
<?php
		...
		$query=mysqli_query($con,"select * from trips WHERE branch='$branch_name' and driver='$driver' ")or die(mysqli_error());
