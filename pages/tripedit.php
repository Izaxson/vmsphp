...
?>
                     ...
                     <td><?php echo $row['veh_registration'];?></td>
                        ...
                        <td>
				<a href="#updateordinance<?php echo $row['id'];?>" data-target="#updateordinance<?php echo $row['id'];?>" data-toggle="modal" class="btn btn-warning">Edit</a>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="veh_registration" value="<?php echo $row['veh_registration'];?>" readonly>  
          </div>
        </div>
		<div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="first_reading" value="<?php echo $row['first_reading'];?>" readonly>  
          </div>
        </div>
			<div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="time_out" value="<?php echo $row['time_out'];?>"readonly  >  
          </div>
        </div>  
	<div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="Purpose_of_journey" value="<?php echo $row['Purpose_of_journey'];?>" readonly>  
          </div>
        </div> 
			<div class="form-group">
