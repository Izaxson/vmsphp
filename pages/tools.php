...
<html>
  <head>
    ...
    <title>Tools | <?php include('../dist/includes/title.php');?></title>
	      ...
	      <div class="col-md-4">
            ...
            <div class="col-xs-8">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title"> Tools  Records</h3>
                </div><!-- .box-header -->
...
<?php
		...
		$query=mysqli_query($con,"select * from tools where branch='$branch_name'")or die(mysqli_error());
