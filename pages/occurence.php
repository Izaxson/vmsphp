...
<html>
  <head>
    ...
    <title>Occurence  Record | <?php include('../dist/includes/title.php');?></title>
  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
   ...
   <a class="btn btn-lg btn-warning" href="#">NEW OCCURENCE /HANDOVER</a>              
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Occurence Records</li>
            </ol>
          </section>
	      ...
	      <div class="col-md-4">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New Occurence  Record </h3>
                </div>
                <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="occurence_add.php" enctype="multipart/form-data">
            ...
            <select class="form-control select2" style="width:100%" name="veh_registration" required>
                ...
                ?>
				  ...
				  <!-- /.form group -->
				   <div class="form-group">
                    <label for="date">Occurence</label>
                    <div class="input-group col-md-12">
                       <input type="textarea" class="form-control pull-right" id="date" name="Occurence" placeholder="Occurence" required>
                    </div><!-- /.input group -->
                  </div>
...
<?php
		...
		$query=mysqli_query($con,"select * from occurence where branch='$branch_name'")or die(mysqli_error());
