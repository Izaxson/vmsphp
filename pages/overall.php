          ...
          <!-- /.box -->       
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Overall Report from <?php 
                    ...
                    <thead>
                      <tr>
                        <th>Total Sales <?php
							...
							$query=mysqli_query($con,"select *,SUM(amount_due) as total from sales where 
		date(date_added)>='$start' and date(date_added)<='$end'")or die(mysqli_error($con));
                    ...
                    <tfoot>
                      <tr>
                        <th style="padding-left:50px">Less Expenses</th>
						<th> </th>
						<th> </th>
                      </tr>	
<?php
...
<?php
		...
		$query=mysqli_query($con,"select *,SUM(amount_due) as credit from sales where 
		date(date_added)>='$start' and date(date_added)<='$end' and modeofpayment='credit'")or die(mysqli_error($con));
...
?>
                      <tr>
                        <th style="padding-left:50px">Less: Accounts Receivable</th>
                        <td style="text-align:right"><?php echo $ar;?></td>
                      </tr>		
<tr>
                    
					<tr>
						<th><h3>Cash On Hand</h3></th>
						<th></th>
						<th style="text-align:right"><h3><?php echo number_format($prod-$expense-$ar,2);?></h3></th>
					</tr>	
                    </tfoot>
                  </table>
                </div><!-- /.box-body -->
