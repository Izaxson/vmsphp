      ...
      <div class="content-wrapper">
        <div class="container">
	      ...
	      <div class="col-md-4">
            ...
            <select class="form-control select2" style="width:50%" name="veh_registration" required>Vehicle Registration
                <?php
                ...
                ?>
				  ...
				  <!-- /.form group -->
				   ...
				   <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="time" class="form-control pull-right" id="date" name="time_out"  >
                    </div><!-- /.input group -->
                  </div>
				 <div class="form-group">
				  ...
				  <label for="date">SHIFT </label>
                    <div class="input-group col-md-12">
                      <select  name = "shift" class = "form-control">
							<option value = ""	></option>					 
							<option value = "A-DAY SHIFT ">A-DAY SHIFT</option>					 
							<option value = "B-NIGHT SHIFT ">B-NIGHT SHIFT</option>					 
