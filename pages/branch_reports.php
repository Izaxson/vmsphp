...
?>      
				  ...
				  <h5><b>Trips Report as of <?php echo date("M d, Y",strtotime($start))." to ".date("M d, Y",strtotime($end));?></b></h5>
			...
			<table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
<?php
	$query=mysqli_query($con,"select * from trips  where Date>='$start' and Date<='$end' AND veh_registration='$veh_registration' ")or die(mysqli_error($con));
		$grand=0;$distance=0;
...
?>
            <tr>
			      <td>Tripid00<?php echo $row['id']?></td>
 ...
 <?php }?>                       
                    ...
                    <tfoot>
       <!--<tr>
            <th colspan="8">Total Distance Covered in Kms</th>
