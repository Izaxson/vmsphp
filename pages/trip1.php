          ...
          <section class="content-header">
            <h1>
              <a class="btn btn-lg btn-warning" href="home.php">Back</a>
               <a class="btn btn-lg btn-warning" href="new_trip.php">Add Trips</a>
...
<?php
		...
		$query=mysqli_query($con,"select * from trips WHERE branch='$branch_name'")or die(mysqli_error());
		while($row=mysqli_fetch_array($query)){
		
?>
                      <tr>
					   <td>TripID-<?php echo $row['id'];?></td>
