...
<div class="login-box">
	  ...
	  <img src="Realtripslogo.jpg" height='130' width='150' alt="..." class="img-circle profile_img"><br> <br>
	   ...
	   <div class="login-logo">
	 <img src="Realtripslogo.jpg" alt="sgs logo" width="350" height="150"><br>
       </div>
	   <button type="submit" class="btn btn-success btn-block btn-flat" name="login"<a href="vehiclelog/index.php"</a> Driver  LogIn</button>
      <div class="login-box-body">
        ...
        <form action="login.php" method="post">
          ...
          <div class="row">
			...
			<div class="col-xs-6 pull-right">
              <button type="submit" class="btn btn-success btn-block btn-raised" name="login" default>Sign In</button>
            </div><!-- /.col -->
