	...
	//	$date=explode('-',$date);
		...
		<div class="col-md-12">
				  ...
				  <a class = "btn btn-warning btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Print</a>
							<a class = "btn btn-warning btn-print" href = "overall.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a>   
...
?>
 ...
 <?php }?>                       
                      ...
                      <tfoot>
                      <tr>
                        <th colspan="3">Total Fuel Amount</th>
                       ...
                       <tr>
                        <th colspan="3">Total Litres  Fuelled</th>
