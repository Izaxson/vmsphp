...
<html>
  <head>
    ...
    <title>Trip Report | <?php include('../dist/includes/title.php');?></title>
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main"> 
			...
			<div class = "panel">
				<div class="panel-heading">
				  <h3 class="box-title">Trip Report Per Station</h3>
				...
				<div class="box-body">
				  ...
				  <!-- /.form group -->
					...
					<div class="form-group col-md-6">
						...
						<input type="date" name="date1" class="form-control pull-left active" style="width:50%" id="reservation" required>
					</div>
					<label>To:</label>
					<div class="input-group">
						  <div class="input-group-addon">
						...
						<input type="date" name="date2" class="form-control pull-left active" style="width:50%" id="reservation" required>
					</div>
			...
			<?php
		  	  ...
		  	  <label>Station:</label>
		    <div class="form-group">
                       <select class="form-control select2" style="width:25%" name="branch" required>
			<?php
				include('dist/includes/dbcon.php');
	...
	//	$date=explode('-',$date);
		...
		<div class="col-md-12">
				  ...
				  <h5><img src="Capture.PNG" alt="sgs logo" width="400" height="100"><br><b><?php echo $_POST['branch'];?> <BR>  TRIP  REPORT FOR   <?php echo $_POST['veh_registration'];?> <BR>AS OF <?php echo date("M d Y",strtotime($start))." to ".date("M d Y",strtotime($end));?></b></h5>
		...
		<div class="table table-bordered"style="overflow-x:auto;">
			<table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
<?php
	$query=mysqli_query($con,"select * from trips  where Date>='$start' and Date<='$end' AND veh_registration='$veh_registration' AND branch='$branch' ORDER BY Date ASC")or die(mysqli_error($con));
		$distance=0;
...
?>
 ...
 <?php }?>                       
                      ...
                      <tr>
                        <th colspan="3">Total Distance covered</th>
                        
						
						<th colspan="2"><?php echo number_format($distance);?>  Kms</th>
