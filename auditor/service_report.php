...
<html>
  <head>
    ...
    <title>Service  Report | <?php include('../dist/includes/title.php');?></title>
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main"> 
			...
			<div class = "panel">
				<div class="panel-heading">
				  <h3 class="box-title">Service  Report Per Station</h3>
	...
	//		$start=date("Y/m/d",strtotime($date1));
		...
		<div class="col-md-12">
				  ...
				  <h5><img src="Capture.PNG" alt="sgs logo" width="400" height="100"><br><b><?php echo $_POST['branch'];?> <BR> VEHICLE  SERVICE  REPORT FOR   <?php echo $_POST['veh_registration'];?><BR><BR>
                  
				  <a class = "btn btn-success btn-print" href = "" onclick = "window.print()"><i class ="glyphicon glyphicon-print"></i> Print</a>
							<a class = "btn btn-primary btn-print" href = "overall.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a>   
			...
			<table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
<?php
	//$query=mysqli_query($con,"select * from service  where  veh_registration='$veh_registration' AND branch='$branch' ORDER BY id ASC")or die(mysqli_error($con));
            ...
            <tr>
			     <td><?php echo $row['veh_registration'];?></td>
                       ...
                       <td><?php echo $row['Date_out'];?></td>
						...
						<td><?php echo $row['Nature_of_service'];?></td>
