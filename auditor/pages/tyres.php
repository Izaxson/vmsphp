...
<html>
  <head>
    ...
    <title>Record of Tyres | <?php include('../dist/includes/title.php');?></title>
	      ...
	      <div class="col-md-4">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Add New Tyre Record</h3>
                </div>
                <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="tyres_add.php" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
				   ...
				   <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="make" placeholder="Make of Tyre" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				  <!-- /.form group -->
				
				   <div class="form-group">
                    <label for="date">Tyre Size </label>
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="size" placeholder="Tyre Size" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				   <div class="form-group">
				   ...
				   <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="Position" placeholder="Tyre Position" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				   <div class="form-group">
                    <label for="date">Comments</label>
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="Comments" placeholder="Comments" required>
                    </div><!-- /.input group -->
                  </div>
            ...
            <div class="col-xs-8">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Tyre Record List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"select * from tyres")or die(mysqli_error());
