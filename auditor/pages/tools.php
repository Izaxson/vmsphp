			  ...
			  <form class="form-horizontal" method="post" action="tools_update.php" enctype='multipart/form-data'>
                <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <textarea class="form-control pull-right" id="veh_registration" name="veh_registration" placeholder="Vehicle Registration Number" required><?php echo $row['tyre_id'];?></textarea>
                    </div><!-- /.input group -->
                 </div>
				<div class="form-group">
