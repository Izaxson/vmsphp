        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
                      ...
                      <li>
                        ...
                        <ul class="menu">
                          ...
                          <li><!-- start notification -->
                            <a href="tripApproval.php">
                            <i class="glyphicon glyphicon-list text-orange"></i>  Approve Trip </a>
                          </li><!-- end notification -->
						  <li><!-- start notification -->
                            <a href="trip.php">
                               <i class="glyphicon glyphicon-list text-orange"></i>View Trips</a>
						 		...
						 		<!-- start notification -->
                            <li><!-- start notification -->
                            <a href="myapprovals.php">
                             <i class="glyphicon glyphicon-list text-orange"></i>My Approvals</a>
							   
                          </li>
						    <li><!-- start notification -->
                            <a href="new_trip.php">
                             <i class="glyphicon glyphicon-list text-orange"></i>Add  Trip</a>
			...
			?>
				  ...
				  <li class="">
                    <!-- Menu Toggle Button -->
                    <a href="occurence.php" class="dropdown-toggle">
                  ...
                  <li class="">
				   ...
				   <!--<li class="">
                    <!-- Menu Toggle Button --
                    <a href="3" class="dropdown-toggle">
                      <div class="profile_pic">
                <img src="driver.png"  alt="..." class="img-circle profile_img">	
              </div></i>
