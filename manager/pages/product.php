        ...
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-primary" href="product_add.php" data-target="#add" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-plus text-blue"></i></a>
            </h1>
            <ol class="breadcrumb">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="desc" value="<?php echo $row['prod_desc'];?>" required>  
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="file">Vehicle Registration </label>
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="supplier" required>
						  <option value="<?php echo $row['vehicle_id'];?>"><?php echo $row['vehicle_registration'];?></option>
					      <?php
						
							$query2=mysqli_query($con,"select * from vehicle")or die(mysqli_error());
							  while($row2=mysqli_fetch_array($query2)){
					      ?>
							    <option <?php echo $row2['vehicle_registration'];?></option>
					      <?php }?>
					    </select>
					</div>
				</div> 
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Journey Record</h4>
              </div>
              <div class="modal-body">
      ...
      <div class="form-group">
          ...
          <div class="col-lg-9">
              ...
              $query2=mysqli_query($con,"select * from vehicle")or die(mysqli_error());
                while($row2=mysqli_fetch_array($query2)){
                ?>
                  <option value="<?php echo $row2['vehicle_id'];?>"><?php echo $row2['vehicle_registration'];?></option>
                <?php }?>
              </select>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Speedometer </label>
          <div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" required>  
            <input type="number" class="form-control" id="reading1" name="reading1" placeholder="First Reading "  required> 
			 <input type="number" class="form-control" id="reading2" name="reading2" placeholder="Second  Reading "  required> 
			
			  <input type="text" class="form-control" id="distance" name="distance" placeholder="Distance covered" required> 
			   <input type="submit"  id="submit" name="Calculate" required> 
          </div>
        </div> 
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Time</label>
          <div class="col-lg-9">
            <textarea class="form-control" id="time_out"  placeholder="Time Out " required></textarea>  
			<textarea class="form-control" id="time_in"  placeholder="Time In" required></textarea>  
          </div>
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Purpose of Journey </label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="purpose" name="purpose" placeholder="Purpose of Journey " required>  
          </div>
        </div>
