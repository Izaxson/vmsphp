                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>User  Id:</label>
                            <div class="form-line">
                                <input name="txt_facid" type="number" required class="form-control" placeholder="User Id">
                            </div>
                        </div>
                        <div class="form-group">
...
<form method="post">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="defaultModalLabel">Add New Equipment/Item</h4>
            </div>
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-sm-12">
						...
						<div class="form-group">
                            ...
                            <div class="form-line">
                                <input name="Equipment_Name" type="text" class="form-control" placeholder="Equipment Name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Station:</label>
                            <div class="form-line">
                                <input name="Station" type="text" class="form-control" placeholder="Station/Location" required>
                            </div>
                        </div>
						<div class="form-group">
                            <label>Serial Number #:</label>
                            <div class="form-line">
                                <input name="Serial_number" type="TEXT" min="0" class="form-control" placeholder="Serial Number #">
                            </div>
						</div>
						<div class="form-group">
                            <label>Model:</label>
						...
						<div class="form-group">
                            ...
                            <div class="form-line">
                                <input name="OperatingSystem" type="text"  class="form-control" placeholder="Operating System for Computers">
                            </div>
						</div>
						<div class="form-group">
                            <label>Owner :</label>
                            <div class="form-line">
                                <input name="OperatingSystem" type="text"  class="form-control" placeholder="Owner">
                            </div>
						</div>
                       <!-- <div class="form-group">
                            <label>Firstname:</label>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-link waves-effect" name="btn_addEquip" >ADD</button>
                <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">CLOSE</button>
            </div>
        </div>
    </div>
