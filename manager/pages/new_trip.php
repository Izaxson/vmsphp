...
<html>
  <head>
    ...
    <title>New Trip | <?php include('../dist/includes/title.php');?></title>
      ...
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              <a class="btn btn-lg btn-warning" href="home.php">Back</a>
			   <a class="btn btn-lg btn-warning" href="#">NEW TRIP/JOURNEY</a>
              
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Add Trip 
			  </li>
            </ol>
          </section>
	      ...
	      <div class="col-md-4">
            ...
            <select class="form-control select2" style="width:100%" name="veh_registration" required>Vehicle Registration
                <?php
                ...
                ?>
				  ...
				  <!-- /.form group -->
                    ...
                    <div class="input-group col-md-12">
                       <input type="number" class="form-control pull-right" id="date" name="Second_reading" placeholder="Second Speedometer  Reading" >
                    </div><!-- /.input group -->
                  </div>
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="time_out" value=" <?php echo date("h:i:s");?>" readonly>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
				 <div class="form-group">
                    <label for="date">Time In </label>
                    <div class="input-group col-md-12">
                      <input type="time" class="form-control pull-right" id="date" name="time_in"  >
                    </div><!-- /.input group -->
                  </div>
				  <div class="form-group">
                    <label for="date">Purpose of Journey </label>
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="Purpose_of_journey" placeholder="Purpose of Journey" required>
                    </div><!-- /.input group -->
                  </div>
				  <div class="form-group">
		...
		<!-- <div class="form-group">
            <select class="form-control select2" style="width:100%" name="gauge_reading" required>Gauge  Reading
               
                    <option value="Full Tank" ></option>
					   <option value="Full Tank" >FULL TANK</option>
					     <option value="Full Tank" >THREE QUARTER TANK</option>
                     <option value="Full Tank" >HALF  TANK</option>
					 <option value="Full Tank" >EMPTY  TANK</option>
                </select>
          </div>-->
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <button class="btn btn-warning" id="daterange-btn" name="submit">
                        Save
                      </button>
           ...
           <!-- <div class="col-xs-8">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Occurence    Records</h3>
                </div><!-- .box-header --
                <div class="box-body">
