    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-red">
                          ...
                          <a href="tripapproval.php" class="small-box-footer">
        ...
        <div class="col-md-4">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
				<div class="navbar nav_title" height='100' width='100'style="border: 0;">
              <b><a href="#" class="site_title"><i class="fa fa-cog"></i> <span>MANAGER</span></a></b>
            </div>
...
?>
                <div class="box-body">
				  ...
				  <img src="manager.png" height='66' width='76' alt="..." class="img-circle profile_img"><br>
 ...
 <div class="login-logo">
	  ...
	  <img src="Realtripslogo.jpg" height='120' width='150' alt="..." class="img- profile_img"><br> <br>
       </div><!-- /.login-logo -->
