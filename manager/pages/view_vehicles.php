...
<html>
  <head>
    ...
    <title>Vehicles | <?php include('../dist/includes/title.php');?></title>
        ...
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-primary" href="vehicles.php">Add Vehicle </a>
			     <a class="btn btn-lg btn-warning" href="#"> VEHICLES RECORDS</a>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header">
                  <h3 class="box-title">Vihecles  List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
